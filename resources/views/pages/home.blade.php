...
@section('content')
    <!-- Content -->
      ...
      <!-- ======= Portfolio Section ======= -->
      <section id="portfolio" class="portfolio portfolio">
        <div class="container">
      ...
      <!-- ======= Galeri Section ======= -->
      <section id="galeri" class="portfolio galeri">
        <div class="container">
      ...
      <section id="faq" class="faq">
        <div class="container">
          ...
          <ul class="faq-list">
            ...
            <li>
              <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">Bagaimana cara mengisi tetimoni? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
            ...
            <li>
              <div data-bs-toggle="collapse" href="#faq3" class="collapsed question">Apakah perlu login sebelum melakukan pemesanan? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
